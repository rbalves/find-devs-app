            ...
            >
                <Center>
                    <Image
                        ...
                        m={4}
                    />
                    <Text style={{color: colors.white, fontWeight:'700', fontSize:22, marginBottom:10}}>CRIAR CONTA</Text>
                </Center>
            </VStack>
                ...
                {!isConfirmCode ? (
                    ...
                    <FormControl>
                        <Input 
                            ...
                            InputLeftElement={
                                <Icon as={<MaterialIcons name="face-retouching-natural" />}
                                    size={5}
                                    ml="2"
                                    mr="2"
                                    color={colors.gray4}
                    ...
                    <FormControl>
                        <Input 
                            ...
                            InputLeftElement={
                                <Icon as={<MaterialIcons name="phone-android" />}
                                    size={5}
                                    ml="2"
                                    mr="2"
                                    color={colors.gray4}
                    ...
                    <FormControl>
                        <Input 
                            ...
                            keyboardType='numeric'
                            InputLeftElement={
                                <Icon as={<MaterialIcons name="code" />}
                                    size={5}
                                    ml="2"
                                    mr="2"
                                    color={colors.gray4}
